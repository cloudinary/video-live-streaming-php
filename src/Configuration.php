...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.cloudinary.com/v2/video/CLOUD_NAME';
     ...
     * @var string
     */
    protected $userAgent = 'CloudinaryVideoLiveStreamingPHP/0.1.1 (PHP ' . PHP_VERSION . ')';
    ...
    public function setHostCloudName($cloudName)
    {
        ...
        $this->host = $this->getHostFromSettings(0, [$variableName => $cloudName]);
    ...
    {
        $report  = 'PHP SDK (Cloudinary\Video\LiveStreaming) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 0.1.10' . PHP_EOL;
