...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.cloudinary.com/v2/CLOUD_NAME/video';
     ...
     * @var string
     */
    protected $userAgent = 'CloudinaryVideoLiveStreamingPHP/0.1.0 (PHP ' . PHP_VERSION . ')';
    ...
    public function getHostSettings(): array
    {
        return [
            [
                "url" => "https://api.cloudinary.com/v2/{cloudName}/video",
