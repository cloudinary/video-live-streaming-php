...
/**
 * MessageWrappedResponse Class Doc Comment
 *
 * @package  Cloudinary\Video\LiveStreaming
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MessageWrappedResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'MessageWrappedResponse';
    ...
    protected static array $openAPITypes = [
        'requestId' => 'string',
        'data' => '\Cloudinary\Video\LiveStreaming\Model\MessageWrappedResponseData'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Cloudinary\Video\LiveStreaming\Model\MessageWrappedResponseData
     */
    public function getData(): \Cloudinary\Video\LiveStreaming\Model\MessageWrappedResponseData
    {
     ...
     * Sets data
     *
     * @param \Cloudinary\Video\LiveStreaming\Model\MessageWrappedResponseData $data data
     *
     * @return $this
     */
    public function setData(\Cloudinary\Video\LiveStreaming\Model\MessageWrappedResponseData $data): static
    {
        if (is_null($data)) {
