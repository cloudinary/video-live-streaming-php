...
/**
 * ErrorWrappedResponse Class Doc Comment
 *
 * @package  Cloudinary\Video\LiveStreaming
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ErrorWrappedResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ErrorWrappedResponse';
    ...
    protected static array $openAPITypes = [
        'requestId' => 'string',
        'error' => '\Cloudinary\Video\LiveStreaming\Model\MessageWrappedResponseData'
    ];
    ...
    */
     ...
     * Gets error
     *
     * @return \Cloudinary\Video\LiveStreaming\Model\MessageWrappedResponseData|null
     */
    public function getError(): ?\Cloudinary\Video\LiveStreaming\Model\MessageWrappedResponseData
    {
     ...
     * Sets error
     *
     * @param \Cloudinary\Video\LiveStreaming\Model\MessageWrappedResponseData|null $error error
     *
     * @return $this
     */
    public function setError(?\Cloudinary\Video\LiveStreaming\Model\MessageWrappedResponseData $error): static
    {
        if (is_null($error)) {
