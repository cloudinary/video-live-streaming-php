...
/**
 * LiveStreamWrappedResponse Class Doc Comment
 *
 * @package  Cloudinary\Video\LiveStreaming
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class LiveStreamWrappedResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'LiveStreamWrappedResponse';
    ...
    protected static array $openAPITypes = [
        'requestId' => 'string',
        'data' => '\Cloudinary\Video\LiveStreaming\Model\LiveStreamResponse'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Cloudinary\Video\LiveStreaming\Model\LiveStreamResponse
     */
    public function getData(): \Cloudinary\Video\LiveStreaming\Model\LiveStreamResponse
    {
     ...
     * Sets data
     *
     * @param \Cloudinary\Video\LiveStreaming\Model\LiveStreamResponse $data data
     *
     * @return $this
     */
    public function setData(\Cloudinary\Video\LiveStreaming\Model\LiveStreamResponse $data): static
    {
        if (is_null($data)) {
